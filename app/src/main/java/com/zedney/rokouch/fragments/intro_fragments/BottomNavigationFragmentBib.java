 ...
 */
public class BottomNavigationFragmentBib extends Fragment {
    ...
    private  int mMargin;
    public BottomNavigationFragmentBib() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_bottom_navigation_bib, container, false);
